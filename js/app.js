...
// when you want artist1 do console.log(allArtists[0]);
// when you want artist2 do console.log(allArtists[1]);
// when you want artist3 do console.log(allArtists[2]);
// when you want artist4 console.log(allArtists[3]);
function getArtist() {
...
for (let i=0;i<sections.length;i++) {
    ...
    artistList += "<tr><td>Label</td><td>" + allArtists[i].label + "</td></tr>";
